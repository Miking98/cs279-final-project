...
############################################################
# BUG FIX - From: https://github.com/matterport/Mask_RCNN/issues/1930#issuecomment-713282628
############################################################
...
class MaskRCNN():
    ...
    def load_weights(self, filepath, by_name=False, exclude=None):
        ...
        try:
            ...
            from keras.engine import topology as hdf5_format
    ...
    def compile(self, learning_rate, momentum):
        ...
        ######
        # Comment out below 2 lines due to: https://github.com/matterport/Mask_RCNN/issues/1889#issuecomment-569409304
        ######
        ...
        for name in loss_names:
            ...
            loss = (
                ...
                * self.config.LOSS_WEIGHTS.get(name, 1.))
            ######
            # Per: https://github.com/matterport/Mask_RCNN/issues/1754#issuecomment-537229738
            #####
            print(name, layer, loss)
